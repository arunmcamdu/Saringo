...
<div class="dwqa-questions-archive">
	<!-- do_action( 'dwqa_before_questions_archive' -->
		...
		<div class="dwqa-questions-footer">
			...
			<?php if ( dwqa_current_user_can( 'post_question' ) ) : ?>
				<div class="dwqa-ask-question hide"><a href="<?php echo dwqa_get_ask_link(); ?>"><?php _e( 'Ask Question', 'dwqa' ); ?></a></div>
			<?php endif; ?>
		</div>

	<!-- do_action( 'dwqa_after_questions_archive' ) -->
</div>
